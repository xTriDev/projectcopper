...
function projectcopper:golem/check_oc_shrine_a
function projectcopper:golem/check_oc_shrine_b
function projectcopper:golem/check_oc_shrine_c
...
execute unless score $ocShrine shrine_score matches 9 run schedule function projectcopper:fail/game_fail 3s append
