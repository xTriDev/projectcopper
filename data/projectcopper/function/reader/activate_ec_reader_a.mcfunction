...
execute if score $ecShrine golem_a_pose matches 0 run fill 990 1 992 990 3 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ecShrine golem_a_pose matches 1 run fill 990 1 992 990 2 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ecShrine golem_a_pose matches 2 run fill 990 1 992 990 1 992 minecraft:redstone_lamp[lit=true] strict
