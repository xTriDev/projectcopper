...
execute if score $cShrine golem_c_pose matches 0 run fill 1008 1 1010 1008 1 1010 minecraft:redstone_lamp[lit=true] strict
execute if score $cShrine golem_c_pose matches 1 run fill 1008 1 1010 1008 2 1010 minecraft:redstone_lamp[lit=true] strict
execute if score $cShrine golem_c_pose matches 2 run fill 1008 1 1010 1008 3 1010 minecraft:redstone_lamp[lit=true] strict
execute if score $cShrine golem_c_pose matches 3 run fill 1008 1 1010 1008 4 1010 minecraft:redstone_lamp[lit=true] strict
