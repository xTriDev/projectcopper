...
execute if score $ecShrine golem_b_pose matches 0 run fill 992 1 992 992 1 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ecShrine golem_b_pose matches 1 run fill 992 1 992 992 2 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ecShrine golem_b_pose matches 2 run fill 992 1 992 992 3 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ecShrine golem_b_pose matches 3 run fill 992 1 992 992 4 992 minecraft:redstone_lamp[lit=true] strict
