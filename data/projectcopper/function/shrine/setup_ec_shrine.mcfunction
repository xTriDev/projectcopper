...
summon minecraft:marker 987 10 987 {Tags:["projectcopper.reader_pending","projectcopper.reader_a"]}
summon minecraft:marker 987 10 987 {Tags:["projectcopper.reader_pending","projectcopper.reader_b"]}
summon minecraft:marker 987 10 987 {Tags:["projectcopper.reader_pending","projectcopper.reader_c"]}
