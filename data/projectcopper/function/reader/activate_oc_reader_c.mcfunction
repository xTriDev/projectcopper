...
execute if score $ocShrine golem_c_pose matches 0 run fill 1010 1 992 1010 1 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ocShrine golem_c_pose matches 1 run fill 1010 1 992 1010 2 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ocShrine golem_c_pose matches 2 run fill 1010 1 992 1010 3 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ocShrine golem_c_pose matches 3 run fill 1010 1 992 1010 4 992 minecraft:redstone_lamp[lit=true] strict
