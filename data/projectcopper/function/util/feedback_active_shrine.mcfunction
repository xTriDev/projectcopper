...
execute if score $cShrine shrine_order = $game round if score $cShrine shrine_feedback matches 0 run function projectcopper:util/feedback_c_shrine
...
execute if score $ecShrine shrine_order = $game round if score $ecShrine shrine_feedback matches 0 run function projectcopper:util/feedback_ec_shrine
...
execute if score $wcShrine shrine_order = $game round if score $wcShrine shrine_feedback matches 0 run function projectcopper:util/feedback_wc_shrine
...
execute if score $ocShrine shrine_order = $game round if score $ocShrine shrine_feedback matches 0 run function projectcopper:util/feedback_oc_shrine
