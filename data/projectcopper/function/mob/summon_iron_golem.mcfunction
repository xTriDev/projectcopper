...
{Tags:["projectcopper.iron_golem"],PersistenceRequired:1b,CustomNameVisible:1b,CustomName:{"bold":true,"color":"white","text":"Gate Guardian"},DeathLootTable:"projectcopper:mob/iron_golem"}
