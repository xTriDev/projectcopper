...
execute if score $cShrine shrine_order = $game round \
  ...
  run function projectcopper:shrine_golem/check_c_shrine
...
execute if score $ecShrine shrine_order = $game round \
  ...
  run function projectcopper:shrine_golem/check_ec_shrine
...
execute if score $wcShrine shrine_order = $game round \
  ...
  run function projectcopper:shrine_golem/check_wc_shrine
...
execute if score $ocShrine shrine_order = $game round \
  ...
  run function projectcopper:shrine_golem/check_oc_shrine
