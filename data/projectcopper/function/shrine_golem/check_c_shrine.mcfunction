...
function projectcopper:shrine_golem/check_c_shrine_a
function projectcopper:shrine_golem/check_c_shrine_b
function projectcopper:shrine_golem/check_c_shrine_c
...
execute if score $cShrine shrine_score matches ..8 if score $game game_fail matches 0 run schedule function projectcopper:fail/game_fail 3s append
