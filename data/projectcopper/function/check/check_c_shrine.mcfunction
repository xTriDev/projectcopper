...
function projectcopper:check/check_c_shrine_a
function projectcopper:check/check_c_shrine_b
function projectcopper:check/check_c_shrine_c
...
execute if score $cShrine shrine_score matches 9 if score $game solved matches 0 run function projectcopper:game/round_complete
