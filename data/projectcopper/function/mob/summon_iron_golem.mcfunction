...
{Tags:["projectcopper.iron_golem","projectcopper.mob"],PersistenceRequired:1b,CustomName:{"bold":true,"color":"gold","text":"Gatekeeper Golem"},DeathLootTable:"projectcopper:mob/iron_golem",attributes:[{id:"minecraft:scale",base:1.1}]}
