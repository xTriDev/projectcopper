...
execute if score $ocShrine golem_a_pose matches 0 run fill 1008 1 990 1008 3 990 minecraft:redstone_lamp[lit=true] strict
execute if score $ocShrine golem_a_pose matches 1 run fill 1008 1 990 1008 2 990 minecraft:redstone_lamp[lit=true] strict
execute if score $ocShrine golem_a_pose matches 2 run fill 1008 1 990 1008 1 990 minecraft:redstone_lamp[lit=true] strict
