...
execute if score $wcShrine golem_b_pose matches 0 run fill 992 1 1008 992 1 1008 minecraft:redstone_lamp[lit=true] strict
execute if score $wcShrine golem_b_pose matches 1 run fill 992 1 1008 992 2 1008 minecraft:redstone_lamp[lit=true] strict
execute if score $wcShrine golem_b_pose matches 2 run fill 992 1 1008 992 3 1008 minecraft:redstone_lamp[lit=true] strict
execute if score $wcShrine golem_b_pose matches 3 run fill 992 1 1008 992 4 1008 minecraft:redstone_lamp[lit=true] strict
