...
execute if score $wcShrine golem_a_pose matches 0 run fill 992 1 1010 992 3 1010 minecraft:redstone_lamp[lit=true] strict
execute if score $wcShrine golem_a_pose matches 1 run fill 992 1 1010 992 2 1010 minecraft:redstone_lamp[lit=true] strict
execute if score $wcShrine golem_a_pose matches 2 run fill 992 1 1010 992 1 1010 minecraft:redstone_lamp[lit=true] strict
