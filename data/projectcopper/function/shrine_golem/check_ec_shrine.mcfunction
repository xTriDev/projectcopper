...
function projectcopper:shrine_golem/check_ec_shrine_a
function projectcopper:shrine_golem/check_ec_shrine_b
function projectcopper:shrine_golem/check_ec_shrine_c
...
execute if score $ecShrine shrine_score matches ..8 if score $game game_fail matches 0 run schedule function projectcopper:fail/game_fail 3s append

# Execute when score is 9 (solved)
execute if score $ecShrine shrine_score matches 9 if score $game solved matches 0 run function projectcopper:game/shrine_phase_end
