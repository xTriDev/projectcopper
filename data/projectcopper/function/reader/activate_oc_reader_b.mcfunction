...
execute if score $ocShrine golem_b_pose matches 0 run fill 1008 1 992 1008 3 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ocShrine golem_b_pose matches 1 run fill 1008 1 992 1008 2 992 minecraft:redstone_lamp[lit=true] strict
execute if score $ocShrine golem_b_pose matches 2 run fill 1008 1 992 1008 1 992 minecraft:redstone_lamp[lit=true] strict
