...
execute if score $cShrine golem_b_pose matches 0 run fill 1008 1 1008 1008 3 1008 minecraft:redstone_lamp[lit=true] strict
execute if score $cShrine golem_b_pose matches 1 run fill 1008 1 1008 1008 2 1008 minecraft:redstone_lamp[lit=true] strict
execute if score $cShrine golem_b_pose matches 2 run fill 1008 1 1008 1008 1 1008 minecraft:redstone_lamp[lit=true] strict
